...
public class SuitAcquireImplement implements SuitAcquireInterface{
    ...
    public SuitDataSource getSuitDataSource(String suitname) {
        ...
        String sql = "select name, dbindex, url, username, password from api_suit_datasource where name= ? and dbindex = ?";
    ...
    public List<SuitDataSource> getSuitProducts() {
        String sql = "select name,url from api_suit_datasource group by name ";
